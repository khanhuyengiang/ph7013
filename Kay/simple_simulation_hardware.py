...
__all__ = ['simple_processor','simple_compiler',
           'single_simple_simulation','NTU_single_simple_simulation']
...
def NTU_single_simple_simulation(num_gates, t1 = None, t2 = None, num_qubits = 1,
                                 ...
                                 pulse_amplitude = 1):
    """
    A single simulation with NTU parameters, with num_gates representing the number of rotations.
